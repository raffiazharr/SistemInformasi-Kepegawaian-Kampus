...
<head>
  ...
  <title>Sipeg Universitas Diponegoro</title>
...
<body>
  <nav class="red accent-3" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><b>SIPEG</b><small style="font-size: 19px;"> FEB</small></a>      
      <ul class="right hide-on-med-and-down">
        <li><a class="dropdown-button" href="?page=home">Home<i class="material-icons left">home</i></a></li>
          <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Profil Fakultas<i class="material-icons left">school</i></a></li>
...
<ul id="dropdown1" class="dropdown-content">
  <li><a href="#!">Profil Fakultas</a></li>
  <li><a href="?page=sejarah">Sejarah Fakultas</a></li>
  <li class="divider"></li>
...
<ul class="collapsible" data-collapsible="accordion">
  <li>
    ...
    <ul class="slides">
      <li>
         <img src="https://mm.feb.undip.ac.id/wp-content/uploads/2021/11/universitas-diponegoro-logo.png"> <!-- random image -->
        <div class="caption center-align">
          <h3>Akuntansi</h3>
          <h5 class="light grey-text text-lighten-3">Sistem Informasi Kepegawaian Kampus</h5>
        </div>
      </li>
      <li>
        <img src="https://mm.feb.undip.ac.id/wp-content/uploads/2021/11/universitas-diponegoro-logo.png"> <!-- random image -->
        <div class="caption left-align">
          ...
          <h5 class="light grey-text text-lighten-3">Akuntansi UNDIP</h5>
        </div>
      </li>
      <li>
        <img src="https://mm.feb.undip.ac.id/wp-content/uploads/2021/11/universitas-diponegoro-logo.png"> <!-- random image-->
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3>AYOO .. BELAJAR...!</h3>
          <h5 class=" text-black">Akuntansi UNDIP</h5>
        </div>
      </li>
    </ul>
...
if ($page=='home') {
  echo "<center>
  <i class='material-icons' style='font-size: 130px; color:black;'>school</i>
  <h3>Sistem Informasi Kepegawaian</h3>
  <h4>FEB UNDIP</h4>
</center>";
  # code...
...
<!--END KONTENT-->
  ...
  <footer class="page-footer blue-grey darken-4">
      ...
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="white-text text-lighten-4">
            <b>SIPEG</b> Adalah Sistem Informasi Kepegawaian Kampus yang dibangun menggunakan Framework Bootstrap, dan Pemrograman PHP/MySQL . <br>
            <b>SIPEG</b> dapat digunakan untuk mengolah data kepegwaian kampus, agar pengelolaan data dibidang kepegawaian kampus dapat berjalan dengan baik dan efesien.
          </p>
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="https://www.facebook.com/groups/163146473731770/?ref=group_header">FB : UNDIP FEB (TELKOMP)</a></li>
             <li><a class="white-text" href="https://www.facebook.com/search/top/?q=itschool%20smkei">FB : UNDIP FEB</a></li>
             <li><a class="white-text" href="https://www.facebook.com/search/top/?q=itschool%20smkei">Gmail : FEB@gmail.com</a></li>
    ...
    <div class="footer-copyright red darken-1">
      <div class="container">
      Made by <a target="_blank" class="yellow-text text-lighten-3" href="http://yaminbae.blogspot.com">Raffi Al Yasa Azhar | 12030122140331</a>
      </div>
    </div>
  </footer>
